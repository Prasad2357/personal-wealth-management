...
function PredictionForm() {
  const [formData, setFormData] = useState({
    ...
    City_Tier: "Tier_1",
    Disposable_Income: "",
    Total_Expenses: 0, // Default value set to 0
  });
  ...
  return (
    <div className="prediction-form">
      ...
      <form onSubmit={handleSubmitPrediction}>
        ...
        {/* Total Expenses input removed from the form */}
        <button type="submit">Get Predictions</button>
      </form>
      {predictions && (
        <div className="predictions">
          <h2>Predictions</h2>
          <p>Minimum amount to be saved: {predictions.Predicted_Savings}</p>
          <p>Percentage: {predictions.Predicted_Percentage}</p>
